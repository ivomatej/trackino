// Česká jmeniny – standardní kalendář
// Zdroj: obecně používaný český kalendář jmen (drobné odchylky mezi různými zdroji jsou možné)

const CZECH_NAMEDAYS: Record<string, string> = {
  '01-01': 'Nový rok',   '01-02': 'Karina',      '01-03': 'Radmila',
  '01-04': 'Diana',      '01-05': 'Dalimil',     '01-06': 'Kašpar',
  '01-07': 'Vilma',      '01-08': 'Čestmír',     '01-09': 'Vladan',
  '01-10': 'Mahulena',   '01-11': 'Bohdana',     '01-12': 'Pravoslav',
  ...
  '04-28': 'Vlastimila', '04-29': 'Robert',      '04-30': 'Blahoslav',

  '05-01': 'Vlastislav', '05-02': 'Zikmund',     '05-03': 'Alexej',
  '05-04': 'Květoslav',  '05-05': 'Klaudie',     '05-06': 'Radoslav',
  '05-07': 'Stanislav',  '05-08': 'Inge',        '05-09': 'Ctibor',
  '05-10': 'Blažena',    '05-11': 'Blahomír',    '05-12': 'Pankrác',
  ...
  '06-07': 'Bohuslav',   '06-08': 'Medard',      '06-09': 'Stanislava',
  ...
  '06-28': 'Lubomír',    '06-29': 'Petr',        '06-30': 'Šárka',

  '07-01': 'Jaroslava',  '07-02': 'Patricie',    '07-03': 'Radomír',
  '07-04': 'Prokop',     '07-05': 'Cyril a Metoděj', '07-06': 'Mistr Jan Hus',
  '07-07': 'Bohuslava',  '07-08': 'Nelly',       '07-09': 'Dobroslava',
  ...
  '08-28': 'Augustin',   '08-29': 'Evelína',     '08-30': 'Vladěna',
  '08-31': 'Pavlína',
  ...
  '09-16': 'Ludmila',    '09-17': 'Naďa',        '09-18': 'Kryštof',
  ...
  '10-01': 'Igor',       '10-02': 'Olívie',      '10-03': 'Bohumila',
  ...
  '10-28': 'Zbyněk',     '10-29': 'Silvie',      '10-30': 'Tadeáš',
  '10-31': 'Štěpánka',

  '11-01': 'Felix',      '11-02': 'Dušan',       '11-03': 'Hubert',
  ...
  '11-16': 'Otmar',      '11-17': 'Ota',         '11-18': 'Romana',
  ...
  '12-01': 'Iva',        '12-02': 'Blanka',      '12-03': 'Věnceslav',
  '12-04': 'Barbora',    '12-05': 'Jitka',       '12-06': 'Mikuláš',
  '12-07': 'Ambrož',     '12-08': 'Renata',      '12-09': 'Vratislav',
  ...
  '12-22': 'Šimon',      '12-23': 'Vlasta',      '12-24': 'Adam a Eva',
  '12-25': 'Boženka',    '12-26': 'Štěpán',      '12-27': 'Žaneta',
  '12-28': 'Bohumil',    '12-29': 'Judita',      '12-30': 'David',
  '12-31': 'Silvestr',
};

/** Vrátí jméno jmenin pro daný den (formát 'MM-DD'), nebo null pokud nenalezeno */
export function getCzechNameday(monthDay: string): string | null {
  return CZECH_NAMEDAYS[monthDay] ?? null;
}

/** Vrátí jméno jmenin pro daný Date objekt, nebo null */
export function getCzechNamedayForDate(date: Date): string | null {
  const mm = String(date.getMonth() + 1).padStart(2, '0');
  const dd = String(date.getDate()).padStart(2, '0');
  return CZECH_NAMEDAYS[`${mm}-${dd}`] ?? null;
}
