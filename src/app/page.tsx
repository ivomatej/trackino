...
interface NotificationItem {
  id: string;
  type: 'vacation' | 'request' | 'feedback' | 'invoice' | 'calendar_invite';
  title: string;
  date: string;
  href: string;
}
            ...
            >
              ...
              <div className="space-y-1 max-h-[172px] overflow-y-auto">
                {notifications.map(n => {
                  ...
                  const typeColor = n.type === 'vacation' ? '#10b981' : n.type === 'request' ? '#6366f1' : n.type === 'feedback' ? '#f59e0b' : n.type === 'calendar_invite' ? '#8b5cf6' : '#3b82f6';
                  const typeLabel = n.type === 'vacation' ? 'Dovolená' : n.type === 'request' ? 'Žádost' : n.type === 'feedback' ? 'Připomínka' : n.type === 'calendar_invite' ? 'Pozvánka' : 'Faktura';
