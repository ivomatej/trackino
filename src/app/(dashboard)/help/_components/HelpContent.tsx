...
export function HelpContent() {
  ...
  const { content, loading, editing, saving, editorRef, setEditing, saveContent, startEditing, execCmd, insertLink } = useHelp();
    ...
    <DashboardLayout moduleName="Nápověda">
      <div className="max-w-3xl">
        ...
        <div className="rounded-xl border overflow-hidden" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
          {editing && <HelpToolbar execCmd={execCmd} insertLink={insertLink} />}
