...
<p><strong>Nastavení kalendáře:</strong> Tlačítko ⚙ v levém panelu otevře nastavení. Mřížka vždy zobrazuje celý den (0:00–23:00); nastavit lze pouze <em>Výchozí viditelnou část</em> – selekty Od/Do určují, na jakou hodinu se mřížka automaticky posune při načtení stránky. Mimo viditelnou část lze kdykoli scrollovat. Nastavení se ukládá do localStorage prohlížeče.</p>
