...
<p><strong>Nastavení kalendáře:</strong> Tlačítko ⚙ v levém panelu otevře nastavení rozsahu hodin pro týdenní pohled. Nastavte <em>Rozsah dne</em> (scrollovatelná oblast, např. 6:00–22:00) a <em>Výchozí viditelná část</em> (kde se začne zobrazovat mřížka při načtení stránky). Po uložení se mřížka okamžitě posune na správnou pozici. Nastavení se ukládá do vašeho profilu a přetrvává i po odhlášení.</p>
