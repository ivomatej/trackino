...
<ul>
  ...
  <li><strong>Stav Hotovo</strong> – pokud je v Nastavení zapnutý toggle <em>Stav „Hotovo"</em>: v toolbaru editoru se zobrazí zelené pill tlačítko <em>Hotovo</em>; hotové poznámky jsou ve výpisu zobrazeny s přeškrtnutým názvem, sníženou průhledností (0,45) a zelenou fajfkou; ve výpisu je také přímé tlačítko přepnutí stavu; stav se synchronizuje s databází</li>
