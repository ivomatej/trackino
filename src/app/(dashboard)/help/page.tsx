...
<ul>
  ...
  <li><strong>DALŠÍ KALENDÁŘE</strong> – tři automatické kalendáře: <em>Státní svátky ČR</em> (červená), <em>Jmeniny</em> – jméno dle českého kalendáře pro každý den (fialová), <em>Narozeniny</em> – narozeniny kolegů ve workspace (růžová; dostupné jen pro adminy a uživatele s oprávněním <em>Vidí narozeniny kolegů</em>). Každý lze zapnout/vypnout zaškrtnutím.</li>
