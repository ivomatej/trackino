  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto">
        ...
        {/* Potvrzení odeslání */}
        {sent && (
          <div className="mb-5 p-4 rounded-xl flex items-center gap-3" style={{ background: '#d1fae5', borderLeft: '4px solid #10b981' }}>
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          style={{
            borderColor: fb.is_resolved ? '#10b981' : 'var(--border)',
            background: fb.is_resolved ? '#10b981' : 'transparent',
          }}
