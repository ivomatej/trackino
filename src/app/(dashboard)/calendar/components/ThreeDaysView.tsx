'use client';
// ─── Calendar Module – ThreeDaysView ─────────────────────────────────────────
// Pohled 3 dny (předchozí / dnešek / další) s časovou mřížkou.

import { useCalendarContext } from '../CalendarContext';
import { isSameDay, toDateStr, addDays } from '../utils';
...
export default function ThreeDaysView() {
  const {
    currentDate,
    eventsOnDay,
    today,
